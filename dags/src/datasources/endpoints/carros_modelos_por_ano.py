# /dags/src/datasources/endpoints/carros_modelos_por_ano.py
...
class RequestModelosPorAno(BaseConnector):
    ...
    def get_tabela_carros_modelos_por_ano(self) -> None:
        ...
        for i, parte in enumerate(partes):
            ...
            resultados_tipos_veiculo: List[Optional[Dict[str, Any]]] = []
